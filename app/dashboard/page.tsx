			...
			<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
				<Card>
					...
					<CardContent className="p-4 md:p-6 pt-0">
						<p className="text-2xl md:text-3xl font-bold">Kshs 2,450.00</p>
						<p className="text-xs md:text-sm text-gray-500">+Kshs 150 this month</p>
					</CardContent>
				</Card>
				...
				<Card>
					...
					<CardContent className="p-4 md:p-6 pt-0">
						    <p className="text-2xl md:text-3xl font-bold">Kshs 1,200.00</p>
				...
				<Card>
					...
					<CardContent className="p-4 md:p-6 pt-0">
						...
						<p className="text-xs md:text-sm text-gray-500">Kshs 100 scheduled</p>
					</CardContent>
				</Card>
			</div>
